...
--
-- Host: localhost
-- Generation Time: May 26, 2014 at 11:35 AM
...
INSERT INTO `ticket` (`id`, `game_party_id`, `ticket_template_id`, `user_id`, `payment_id`, `status`, `netto`, `brutto`, `created_at`, `updated_at`) VALUES
(1, 2, 1, 2, 0, 2, 14257, 15000, NULL, NULL);
