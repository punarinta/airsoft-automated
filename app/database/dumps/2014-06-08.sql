...
INSERT INTO `game` (`id`, `name`, `owner_id`, `region_id`, `starts_at`, `ends_at`, `is_visible`, `url`, `created_at`, `updated_at`) VALUES
(1, 'Test game 1', 1, 1, '2014-06-21 00:00:00', '2014-06-22 00:00:00', 1, NULL, NULL, NULL),
(2, 'Test game 2', 1, 4, '2014-06-28 00:00:00', '2014-06-29 00:00:00', 1, NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `ticket` (
  ...
  `vat_paid` int(10) unsigned NOT NULL DEFAULT '0',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;
...
(1, 'org@jesp.ru', '$2y$10$IiMiFJ5iuwGHXraFLPeBR..3QeUUVtPz6dP.Pndo5tLXZQpAZCnXW', 'Organizer', '2014-05-01', 2, 0, 1, 1, '{"locale":"en"}', 'DQJamVeshTfLpwqWXCkhzwCYicwbfxuTOTuhtIswSlYbrpjcw0Ih9YiQhIo0', '2014-05-06 00:00:00', '2014-06-07 12:20:09'),
...
(3, 'player-2@jesp.ru', '$2y$10$IiMiFJ5iuwGHXraFLPeBR..3QeUUVtPz6dP.Pndo5tLXZQpAZCnXW', 'Player 2', NULL, 1, 0, 0, 0, NULL, 'O6WNpkvw7Hxji4GTbFcGyO3jyPDATRnk2RP8FK5Zj7d4XxVH7BTt9R6O9rMs', '2014-05-06 00:00:00', '2014-06-07 11:05:16'),
